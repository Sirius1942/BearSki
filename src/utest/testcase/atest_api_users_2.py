...
class atest_api_users_2(unittest.TestCase,Ski):

    def setUp(self):
        self.logger=logging.getLogger("atest_api_users_2")
    def tearDown(self):
        pass
    @Ski.case()
    def case_api_users_2(self):
        model_name="api_users_2"
        self.logger.info("in case_api_users_2")
